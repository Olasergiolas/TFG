...
def my_sandbox(path, rootfs, ostype):
    ...
    0xc9
    ql.os.set_syscall(0xc9, my_syscall_uid)
...
if __name__ == "__main__":
    '''my_sandbox(["squashfs-root/bin/api.cgi"],
               "squashfs-root", "linux")'''
    my_sandbox(["squashfs-root/bin/nginx",
                "-c", "/mnt/tmp/nginx.conf", "-p", "/var/"],
               "squashfs-root", "linux")
