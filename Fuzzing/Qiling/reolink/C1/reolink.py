...
def my_syscall_write(ql: Qiling, write_fd, write_buf, write_count, *args, **kw):
    ...
    return regreturn
    #return syscall.ql_syscall_write(ql, write_fd, write_buf, write_count, *args)


def my_sandbox(path, rootfs, ostype):
    ql = Qiling(path, rootfs, ostype = ostype, multithread = True, verbose=QL_VERBOSE.DEBUG)
    ql.os.root = True
...
if __name__ == "__main__":
    my_sandbox(["/home/kali/Downloads/C1_1288_18020714/_IPC_36S16MHSM.1288_18020714.C1.ov2710.2MP.WIFI.PTZ.D2.REOLINK.pak.extracted/squashfs-root/usr/sbin/httpd",
                "-h", "/mnt/app/www", "-p", "8080"],
               "/home/kali/Downloads/C1_1288_18020714/_IPC_36S16MHSM.1288_18020714.C1.ov2710.2MP.WIFI.PTZ.D2.REOLINK.pak.extracted/squashfs-root", "linux")
