...
de los fabricantes de reducir gastos de producción en productos de bajo coste del internet de las cosas. \\

Esta misma tendencia se puede observar respecto a la técnica del fuzzing, donde datos de entrada especiales son 
...
dificultad de obtener retroalimentación sobre la ejecución de los bloques básicos de código sin disponer del código
fuente original.
...
D. \textbf{Gustavo Romero López}, Profesor del departamento de Arquitectura y Tecnología de Computadores de la 
...
Quiero agradecer a mis padres y a mi hermano por haberme acompañado y apoyado durante todo este viaje, especialmente
en esos momentos en los que me encontraba en mi límite. A mis amigos y a mi pareja por 
ayudarme cuando tanto necesitaba desconectar y despejarme y por último a mi tutor, Gustavo Romero López
por orientarme pacientemente cuando ni siquiera sabía cómo enfocar este TFG.
