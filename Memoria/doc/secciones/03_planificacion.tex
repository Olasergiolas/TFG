...
Respecto al coste de la mano de 
obra, partimos de las 327 horas estimadas en el diagrama de Gantt (figura \ref{fig:gantt}) durante 3 meses, teniendo en cuenta también un 
salario medio de ingeniero informático junior de 20.000 euros brutos al año. Para llevar a cabo el proyecto se planea dedicar una media de 
4 horas diarias durante todos los días de la semana, lo cual supone un coste de $\sim13'7\euro$ la hora. Los costes de hardware se limitan al
...
como podrían ser dispositivos IoT de domótica. El fuzzing IoT no requiere de ningún hardware específico para el ordenador con el que se va a 
realizar, aunque si ayuda considerablemente el tener suficiente RAM e hilos de CPU para poder aumentar el número de ejecuciones por segundo 
...
Ryzen 5 3600 y una GPU cualquiera (exclusivamente utilizada como salida de vídeo, ya que el Ryzen 5 3600 carece de GPU integrada) puede ser
...
\begin{table}[H]
    ...
    Mano de obra                   & 327           & 13'7                   & 4.479'9                \\
    Ordenador de sobremesa         & 1             & 600                    & 600                    \\
    Servicio de internet (mensual) & 3             & 30                     & 90                     \\
    Servicio de luz (mensual)      & 3             & 10'36                  & 31'08                  \\\hline
                                   &               & \textbf{Total sumado:} & 5200'98$\euro$              
    \end{tabular}
