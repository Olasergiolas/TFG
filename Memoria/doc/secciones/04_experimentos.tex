...
- Diagrama del proceso de fuzzing con UnicornAFL
...
siguiente orden y observamos como el binario compilado para ARM se ejecuta correctamente (figura \ref{fig:qltool})
...
Ahora, respecto al fuzzing si que necesitaremos hacer uso de instrumentación dinámica para saltar esa pausa que imposibilita aplicar fuzzing 
correctamente. Para esto, crearemos un script de Python en el que haremos uso de la API de Qiling para modificar el flujo de ejecución del 
binario y usar como ''main'' del programa la función de cifrado de cadenas de texto.

\subsection{Resultados}
\subsection{Lecciones aprendidas}
Aprendemos de qué forma podemos usar Qiling para posibilitarnos fuzzear cosas y que Qiling está wapo pero realmente donde aprenderemos lecciones importantes es
