...
- Desinfectantes capaces de detectar al instante fallos que fuzzers tardan un poco más
- No todos los fallos de memoria provocan un crash
- Los harness son un punto adicional de fallo y hay que tener cuidado
- Cuidado con el uso de disco.
