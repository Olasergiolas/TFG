...
entre ambos reside en el componente de la aplicación móvil que toman como punto de partida. ''IoTFuzzer'' parte de los métodos a nivel de interfaz gráfica de la app
...
de aplicaciones suelen filtrar el input del usuario, por lo que una gran cantidad de las mutaciones serán descartadas sin siquiera salir de la aplicación.
